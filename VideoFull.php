                ...
                <div class="row">
                    <div class="col-sm-7 col-sm-offset-1">
                        <table id="mitabla">
                            ...
                            <tr>
                                <td>
                                    <h2 class="titulos notas"> 
                                          <?php while ($iteracion = mysql_fetch_object($dameVideo)) { ?>
                                ...
                                <tr>
                                    <th class="imgnotas">
                                        <div>
                                           <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $iteracion->id; ?>" frameborder="0" allowfullscreen></iframe>
                                        </div>
                                    </th>
                                </tr>
